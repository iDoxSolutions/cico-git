...
namespace Cico.Models
{
    ...
    private void AddChecklistTypes(CicoContext context) {
        ...
        private void AddStates(CicoContext context)
        {
            ...
            context.DropdownItems.Add(new DropdownItem() { Description = "C�TE D'IVOIRE", ValueType = "Nations"});
            ...
            context.DropdownItems.Add(new DropdownItem() { Description = "CURA�AO", ValueType = "Nations"});
            ...
            context.DropdownItems.Add(new DropdownItem() { Description = "R�UNION", ValueType = "Nations"});
            ...
            context.DropdownItems.Add(new DropdownItem() { Description = "SAINT BARTH�LEMY", ValueType = "Nations"});
