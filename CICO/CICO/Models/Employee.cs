...
namespace Cico.Models    //  [DisplayName("")]   [StringLength()]
{
    ...
    public partial class Employee:EntityBaseWithKey
    {
       ...
       //1
        ...
        [DisplayName("Email, Personal")]
        [DataType(DataType.EmailAddress)]
        [RegularExpression(@"^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$", ErrorMessage = "Invalid format for personal email address.")]
        public string PersonalEmail { get; set; }
        ...
        [DisplayName("Emergency Contact Email Address")]
        [DataType(DataType.EmailAddress)]
        [RegularExpression(@"^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$", ErrorMessage = "Invalid format for Emergency Contact Email Address.")]
        public string EmergencyContactEmail { get; set; }
        //17
        [DisplayName("Radio Call Sign")]
        [StringLength(65)]
